-- PARA LA SEGUNDA ENTREGA SE AÑADIDERON MÁS REGISTROS A LA BASE DE DATOS
...
-- Agregando 10 estudiantes más
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 17543210, '3', 'Catalina', 'Benítez', 'Molina', 2024, 1, 1);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 17432109, '2', 'Benjamín', 'Castro', 'Pardo', 2024, 2, 3);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 17321098, '1', 'Valentina', 'Díaz', 'Riquelme', 2023, 10, 5);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 17210987, '0', 'Cristóbal', 'Fernández', 'Sandoval', 2023, 11, 7);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 17109876, 'K', 'Jazmín', 'Guajardo', 'Tapia', 2022, 6, 9);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 16987654, '9', 'Nicolás', 'Herrera', 'Valdés', 2022, 1, 11);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 16876543, '8', 'Antonia', 'López', 'Vergara', 2021, 4, 12);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 16765432, '7', 'Sebastián', 'Martínez', 'Villanueva', 2021, 9, 10);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 16654321, '6', 'Francisca', 'Morales', 'Zúñiga', 2024, 7, 8);
INSERT INTO Estudiante (id_estudiante, rut_estudiante, dv_estudiante, nombres_estudiante, apellido_paterno_est, apellido_materno_est, ano_ingreso, id_carrera, id_comuna) VALUES (estudiante_seq.NEXTVAL, 16543210, '5', 'Daniel', 'Núñez', 'Acuña', 2024, 5, 6);
...
-- Agregando 10 evaluaciones más
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 1, 1, TO_DATE('2025-04-10', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 1, 2, TO_DATE('2025-07-08', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 16, 1, TO_DATE('2025-04-20', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 16, 2, TO_DATE('2025-07-12', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 17, 3, TO_DATE('2025-05-15', 'YYYY-MM-DD'), 80);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 10, 1, TO_DATE('2025-05-05', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 21, 4, TO_DATE('2025-06-10', 'YYYY-MM-DD'), 60);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 22, 1, TO_DATE('2025-04-25', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 24, 1, TO_DATE('2025-05-18', 'YYYY-MM-DD'), 100);
INSERT INTO Evaluacion (id_evaluacion, id_asignatura, id_tipo_evaluacion, fecha_evaluacion, puntaje_maximo) VALUES (evaluacion_seq.NEXTVAL, 25, 3, TO_DATE('2025-06-02', 'YYYY-MM-DD'), 50);
...
INSERT INTO Inscripcion (id_inscripcion, id_estudiante, id_asignatura, id_docente, id_semestre, nota_final) VALUES (inscripcion_seq.NEXTVAL, 12, 3, 3, 7, 5.8);
INSERT INTO Inscripcion (id_inscripcion, id_estudiante, id_asignatura, id_docente, id_semestre, nota_final) VALUES (inscripcion_seq.NEXTVAL, 12, 23, 4, 7, 6.1);
INSERT INTO Inscripcion (id_inscripcion, id_estudiante, id_asignatura, id_docente, id_semestre, nota_final) VALUES (inscripcion_seq.NEXTVAL, 14, 5, 5, 7, 4.2);
INSERT INTO Inscripcion (id_inscripcion, id_estudiante, id_asignatura, id_docente, id_semestre, nota_final) VALUES (inscripcion_seq.NEXTVAL, 15, 20, 20, 7, 6.9);
INSERT INTO Inscripcion (id_inscripcion, id_estudiante, id_asignatura, id_docente, id_semestre, nota_final) VALUES (inscripcion_seq.NEXTVAL, 20, 12, 12, 7, 5.5);
...
-- Nuevos datos
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 27, 26, 91);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 28, 28, 78);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 29, 7, 65);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 30, 11, 72);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 31, 31, 95);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 32, 16, 75);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 33, 8, 89);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 34, 26, 60);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 35, 30, 70);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 36, 6, 80);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 37, 9, 85);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 38, 20, 92);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 39, 12, 68);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 40, 4, 88);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 40, 5, 93);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 41, 14, 77);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 42, 6, 45);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 42, 7, 60);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 43, 33, 90);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 44, 9, 70);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 44, 10, 80);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 45, 20, 98);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 46, 12, 82);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 27, 27, 84);
INSERT INTO Resultado_Evaluacion (id_resultado, id_inscripcion, id_evaluacion, puntaje_obtenido) VALUES (resultado_seq.NEXTVAL, 28, 29, 88);
COMMIT;
